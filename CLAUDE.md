...
- **Town:** build/survey panels, day tick + Well-Fed upkeep, unlock cascade b1–b4 (`design/food-upkeep.md`, `design/ui-hud.md`). **Economy v2 designed 2026-07-10** — age-banded levels (Age I = 3, +2/age, cap 11), 9 buildable + 2 shops, Market + Cathedral gold sinks, Timber/Cart cut (`design/town-economy.md` — implementation pending).
...
**Content vs budget (the real gap — the engine is done, the game is ~15% authored):** tech nodes 2/14 · echoes ~25/~50 · enemies 5/12 · bosses 1 placeholder/5 · buildings 4/9 (+2 shops) · attunements 7/~7 (placeholder) · dialogue ~52/~370 pieces · achievements 0/~25 · spine ~9/~22 scenes (Phases C/D mostly unauthored). Counts: `design/content-budget.md`.
...
**Doc-vs-code drift:** RESOLVED 2026-07-10 — Timber, the Woodcutter's Lodge, and the Cart are cut and all docs synced (`design/town-economy.md`). The designed-but-unbuilt buildings (Library, Observatory, Mill, Market, Cathedral) are flagged as such in the docs; they land with the town-economy implementation chunk.
...
**Next agent chunks (agreed order):** town-economy v2 implementation (`design/town-economy.md` — 5 new building files, in-band tech gates, banded-level support, Market logic, Cathedral) → boss #1 design doc (`design/bosses/`, unblocked by the feel gate) → dialogue volume (define remaining arc beats first, add a `max_floor` counter) → remaining tech nodes (blocked on the content-gate verdict).
