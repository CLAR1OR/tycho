...
**Systems — essentially all v1 plumbing is BUILT, tested, and speaks the Ember UI language:**
...
- Detailed design docs: `design/` (see `design/README.md`):
  ...
  - `design/ui-hud.md` — the Ember UI language: every built screen's converged spec + placeholder locations
