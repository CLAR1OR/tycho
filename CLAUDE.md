...
- **Upgraded to Godot 4.7 (2026-06-20).** `project.godot` `config/features` = 4.7; binary at `/home/clarior/Godot_v4.7-stable_linux.x86_64`. Project imports/compiles/runs clean. (4.6.3 binary still on disk; commands should use the 4.7 one.)
