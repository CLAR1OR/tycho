...
- Unlock costs by slot: RMB **3** Dust, Q **4**, R **6**. Levels: L2 ≈ unlock cost, L3 ≈ 1.5×.
- Full kit ≈ 60–70 Dust; the ~7 attunements want the same pool (deliberate tension, PRD §7.3/§7.4 risk). Dust drop rate + a pity rule must be tuned so neither sink starves (PRD §10 already flags this).
