...
| **Etching abilities** | **9** unlockable (3 per slot: RMB / Q / R) + dash (fixed) | Each: 3 upgrade levels (Resonance Dust). ~1 weapon-synergy variant per ability (flagged in data, cheap). |
