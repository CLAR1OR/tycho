...
- `audio.md` — **drafted 2026-07-03; SFX half BUILT 2026-07-04** (buses, `Sfx` autoload, sfx-map data, all phase-1 hooks, synthesized placeholder wavs — the feel gate is no longer silent). Music autoload = the next audio chunk. Human actions: download Kenney packs; pick Suno vs Udio.
