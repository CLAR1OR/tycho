...
- `dialogue/` — dialogue-content batch records: per-batch review docs (drafted lines, gates, judgment calls, flags) for the human curation pass. First batch: `drafts-review-2026-07-04.md` (17 arc beats + 20 barks + 1 contextual, integrated same day, curation pending).
