...
- **Stage costs meant to bite:** 400g + 60 Stone → 900g + 150 Stone → 2,000g + 300 Stone. Sized against the PRE-rebalance sim's 94k-gold-by-run-40 curve — post-rebalance the curve is ~22.8k by run 40, so these likely land near the right bite already; the human dials (rerun the sim after adding the Cathedral to check).
